...
ROMDATA g_PicRom_RunHelp4[] =
{
    ...
    {QObject::trUtf8("常用制动施加"),                       D_FONT_BOLD(7),      QRect( 202, 242, 95,  28),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE         },
    {QObject::trUtf8("常用制动缓解"),                       D_FONT_BOLD(7),      QRect( 202, 272, 95,  28),           Qt::white,                Qt::black,                CONTROL_LABEL,           ID_IGNORE         },
