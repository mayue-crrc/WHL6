...
//    {"<<",                        D_FONT_BOLD(6),      QRect(675, 500,  50,  39),          Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBRESET_PAGEDOWN           },
//    {">>",                        D_FONT_BOLD(6),      QRect(725, 500,  50,  39),          Qt::black,                Qt::gray,                CONTROL_BUTTON,           ID_PIBRESET_PAGEUP             },
#endif


#ifdef PAGE_HEADER_NEW
    D_COMMON_PAGE_HEADER_NEW_DL(QObject::trUtf8("复位") )
//    {"",                       D_FONT_BOLD(4),      QRect(100, 70, 600,  70),          Qt::black,                Qt::gray,                 CONTROL_TRAIN,          ID_PIBRESET_TRAIN                      },
//    {"RIGHT",                  D_FONT_BOLD(6),      QRect(715, 100,  45,  20),          Qt::white,                Qt::white,                CONTROL_ARROW,          ID_PIBRESET_ARROW_RIGHT                },
//    {"LEFT",                   D_FONT_BOLD(6),      QRect( 40, 100,  45,  20),          Qt::white,                Qt::white,                CONTROL_ARROW,          ID_PIBRESET_ARROW_LEFT                 },
#endif
...
#endif
    {"Reset.PNG",           D_DEFAULT_FONT,      QRect(70,  70,  660,  400),         Qt::black,                  Qt::black,                  CONTROL_IMAGE,             ID_PIBRESET_LABEL_1_1      },




};
int g_ResetRomLen = sizeof(g_PicRom_Reset)/sizeof(ROMDATA);

BEGIN_MESSAGE_MAP(C_Page_Reset,CPage)
        ON_SHOWPAGE()
        ON_UPDATE_PAGE()
...
END_MESSAGE_MAP()
C_Page_Reset::C_Page_Reset()
{
}

void C_Page_Reset::OnUpdatePage()
{
    ((CImageCtrl*)GetDlgItem(ID_PIBRESET_LABEL_1_1))->ShowImage();

//    updateTrain(ID_PIBRESET_TRAIN);
//    updateArrow(ID_PIBRESET_ARROW_LEFT,ID_PIBRESET_ARROW_RIGHT);

//    updateErrorLine(ID_PIBRESET_TRAIN);
}

void C_Page_Reset::OnInitPage()
{
...
#ifdef PAGE_BUTTON_BAR_NEW
    void C_Page_Reset::OnComBtn1Clk()
    {
        ChangePage(PAGE_INDEX_RUNSTATE);
    }

    void C_Page_Reset::OnComBtn2Clk()
    {
        ChangePage(PAGE_INDEX_MAINTAIN);
    }

    void C_Page_Reset::OnComBtn3Clk()
    {
         ChangePage(PAGE_INDEX_CARSTATUS3);
    }

    void C_Page_Reset::OnComBtn4Clk()
    {
         //ChangePage(PAGE_INDEX_CARSTATUS2);
        ChangePage(PAGE_INDEX_TCUBLOCKREASON);
    }

    void C_Page_Reset::OnComBtn5Clk()
    {
         ChangePage(PAGE_INDEX_INSTANCYBROADCAST);
    }

    void C_Page_Reset::OnComBtn6Clk()
    {
        ChangePage(PAGE_INDEX_FASPage);
    }
    void C_Page_Reset::OnComBtn7Clk()
    {
        ChangePage(PAGE_INDEX_PISALARM);
    }

    void C_Page_Reset::OnComBtn8Clk()
    {
